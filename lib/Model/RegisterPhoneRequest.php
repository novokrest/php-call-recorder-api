...
/**
 * RegisterPhoneRequest Class Doc Comment
 *
 * @category Class
 * @package  Call\Recorder\Client
 */
class RegisterPhoneRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RegisterPhoneRequest';
