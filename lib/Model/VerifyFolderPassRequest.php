...
/**
 * VerifyFolderPassRequest Class Doc Comment
 *
 * @category Class
 * @package  Call\Recorder\Client
 */
class VerifyFolderPassRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'VerifyFolderPassRequest';
