...
/**
 * UpdateStarRequest Class Doc Comment
 *
 * @category Class
 * @package  Call\Recorder\Client
 */
class UpdateStarRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UpdateStarRequest';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['star'] = isset($data['star']) ? $data['star'] : true;
