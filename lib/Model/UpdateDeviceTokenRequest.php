...
/**
 * UpdateDeviceTokenRequest Class Doc Comment
 *
 * @category Class
 * @package  Call\Recorder\Client
 */
class UpdateDeviceTokenRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UpdateDeviceTokenRequest';
