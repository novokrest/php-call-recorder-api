...
class CreateFileRequest implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'api_key' => 'string',
        'file' => 'string',
        'data' => '\Call\Recorder\Client\Model\CreateFileData'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['file'] = isset($data['file']) ? $data['file'] : 'test/Resources/audio.mp3';
     ...
     * Gets data
     *
     * @return \Call\Recorder\Client\Model\CreateFileData
     */
     ...
     * Sets data
     *
     * @param \Call\Recorder\Client\Model\CreateFileData $data data
     *
     * @return $this
     */
