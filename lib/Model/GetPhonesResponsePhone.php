...
/**
 * GetPhonesResponsePhone Class Doc Comment
 *
 * @category Class
 * @package  Call\Recorder\Client
 */
class GetPhonesResponsePhone implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GetPhonesResponsePhone';
    ...
    {
        $this->container['phone_number'] = isset($data['phone_number']) ? $data['phone_number'] : '';
        $this->container['number'] = isset($data['number']) ? $data['number'] : '';
        $this->container['prefix'] = isset($data['prefix']) ? $data['prefix'] : '';
        $this->container['friendly_name'] = isset($data['friendly_name']) ? $data['friendly_name'] : '';
        $this->container['flag'] = isset($data['flag']) ? $data['flag'] : '';
        $this->container['city'] = isset($data['city']) ? $data['city'] : '';
        $this->container['country'] = isset($data['country']) ? $data['country'] : '';
    }
