...
/**
 * VerifyFolderPassResponse Class Doc Comment
 *
 * @category Class
 * @package  Call\Recorder\Client
 */
class VerifyFolderPassResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'VerifyFolderPassResponse';
