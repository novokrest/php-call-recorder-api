...
/**
 * UpdateProfileImgRequest Class Doc Comment
 *
 * @category Class
 * @package  Call\Recorder\Client
 */
class UpdateProfileImgRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UpdateProfileImgRequest';
