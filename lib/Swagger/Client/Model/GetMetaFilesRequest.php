...
/**
 * GetMetaFilesRequest Class Doc Comment
 *
 * @category Class
 * @package  Call\Recorder\Client
 */
class GetMetaFilesRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GetMetaFilesRequest';
