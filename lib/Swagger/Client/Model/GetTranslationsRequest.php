...
/**
 * GetTranslationsRequest Class Doc Comment
 *
 * @category Class
 * @package  Call\Recorder\Client
 */
class GetTranslationsRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GetTranslationsRequest';
