...
/**
 * RegisterPhoneResponse Class Doc Comment
 *
 * @category Class
 * @package  Call\Recorder\Client
 */
class RegisterPhoneResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RegisterPhoneResponse';
