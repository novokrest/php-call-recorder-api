...
/**
 * DeleteMetaFilesRequest Class Doc Comment
 *
 * @category Class
 * @package  Call\Recorder\Client
 */
class DeleteMetaFilesRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DeleteMetaFilesRequest';
