...
/**
 * GetSettingsRequest Class Doc Comment
 *
 * @category Class
 * @package  Call\Recorder\Client
 */
class GetSettingsRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GetSettingsRequest';
