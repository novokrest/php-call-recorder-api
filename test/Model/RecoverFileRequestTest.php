...
/**
 * RecoverFileRequestTest Class Doc Comment
 *
 * @category    Class
 * @description RecoverFileRequest
 * @package     Call\Recorder\Client
 */
class RecoverFileRequestTest extends \PHPUnit_Framework_TestCase
{
     ...
     */
    public function testRecoverFileRequest()
    {
    }
